...
def my_req_one(name):
    ...
    df_f = pd.concat([df13, df14, df15, df16, df17, df18, df19, df20,
...
def my_req_DAM(name):
    ...
    time.sleep(6)
    df14 = get_dam(name, '20210716T00:00-0000', '20220131T00:00-0000')
    time.sleep(6)
    ...
    time.sleep(6)
    df24 = get_dam(name, '20211216T00:00-0000', '2021231T00:00-0000')
    time.sleep(6)
